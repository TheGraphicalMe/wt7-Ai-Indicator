  ...
  return (
    <section className="relative w-full py-16 pt-0 px-4 z-10 flex flex-col items-center justify-center text-center">
      <div className="w-full max-w-[1000px] mx-auto animate-fade-slide-up hover:scale-[1.01] transition-transform duration-500">
        <p className="font-cond tracking-[0.15em] text-[1rem] uppercase text-[#0DFF7F]/80 mb-5 font-semibold drop-shadow-[0_0_10px_rgba(13,255,127,0.3)]">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
          {[
            ...
            >
              <span className="font-body text-[12px] sm:text-[13px] font-bold text-[#0DFF7F]">{market.name}</span>
              <span className="font-body text-[12px] sm:text-[13px] text-white/70">{market.items}</span>
            </div>
          ))}
        </div>
      </div>
