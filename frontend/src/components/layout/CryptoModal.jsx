          ...
          <div className="relative z-10 w-full flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              <div className="flex-1 flex flex-col gap-4 min-w-0">
                ...
                {/* CTA */}
                <a
                  href={`mailto:smartaitradingpro@gmail.com?subject=${encodeURIComponent(`Crypto Payment for Smart AI ${planName}`)}&body=${encodeURIComponent(`Hello! I've made the crypto payment for the Smart AI ${planName}.\n\nName: \nEmail: \nHash ID: \n\nPlease attach your transaction screenshot to this email.`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-4 rounded-xl flex items-center justify-center gap-2
                         font-cond font-bold text-[0.95rem] tracking-[0.12em] uppercase
                         bg-[#3B82F6] text-white border-none shadow-[0_0_25px_rgba(59,130,246,0.25)]
                         transition-all duration-300 hover:shadow-[0_0_45px_rgba(59,130,246,0.45)] hover:-translate-y-0.5 cursor-pointer"
                >
